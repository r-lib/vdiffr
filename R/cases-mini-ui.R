#' Manage visual test cases with a Mini UI Shiny app
#'
...
#' @export
manage_mini_cases <- function(package = ".", filter = NULL, ..., options = list()) {
...
#' RStudio Addin for managing visual mini cases
#'
